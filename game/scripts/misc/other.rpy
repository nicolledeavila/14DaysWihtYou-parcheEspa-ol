...
default renchatterlist = [
    "¿Has comido hoy?",
    f"¡{persistent.game_open} es mi nuevo número favorito ahora!\n¡Esa es la cantidad de veces que has abierto mi juego! >///<",
    "¡Asegúrate de tomar agua, Angel!",
    "¡Te he extrañado!",
    f"Yaaaaa... ¡Ese es el número {persistent.game_open}! ...¿Hm? Oh, estoy llevando\nla cuenta de cuántas veces has abierto mi juego.",
    "¡TEQUIEROTEQUIEROTEQUIEROTEQUIEROTEQUIERO!",
    "Cariño, son las 2AM, hora de jugar un poco de 14DWY",
    "¡Te quiero, Angel!",
    "¿Oh? ¿Ya estás de vuelta tan pronto?",
    "Una mala gloop y ella hace lo que yo yoinky",
    "Justo estaba pensando en ti, Angel.",
    "¿Estabas pensando en mí? H-Haaah...",
    "...Puedo verte ^^",
    "¿Quieres leer un libro juntos?",
    "¿Tomándote un descanso? ¿Puedo unirme? ^^",
    "¿Quieres almorzar conmigo hoy?",
    "¿Tienes alguna recomendación de libro para mí?",
    "¿Todavía te gusta Haruko? ...Solo pregunto.",
    "¡Ignora a Leon y pasa el rato conmigo hoy!",
    "Hola, Angel.",
    "No estás hablando con otras yanderes, ¿verdad?",
    "Escuché que hay un bot de Discord de 14DWY que\nhace exactamente lo mismo que yo...",
    "¿Quieres leer un libro juntos? ¿Solo nosotros dos?",
    "¿Quieres tocar mi cabello? ^^",
    "*CHUUUUUUU* ¡Te he extrañado, Angel!",
    "Te debe gustar mucho presionar botones, ¿eh? :)",
    "¿También estabas pensando en mí? ¿Por eso estás aquí?",
    "¡Oh, mira! ¡La persona más linda de todo el UNIVERSO está aquí!",
]
